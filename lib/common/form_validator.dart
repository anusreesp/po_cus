...
///Give error if trailing or leading is whitespace
class RequiredValidatorWithTrim extends TextFieldValidator {
  RequiredValidatorWithTrim({required String errorText}) : super(errorText);
...
//
//   ConfirmPasswordValidator({required this.password, required String errorText})
//       : super(errorText);
//
//   @override
//   bool isValid(String? value) {
...
//     try {
//       return hasMatch(value!, password, caseSensitive: true);
//     } catch (_) {
//       return false;
//     }
//   }
