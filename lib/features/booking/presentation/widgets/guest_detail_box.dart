...
import '../pages/booking_table/guest_table.dart';

class GuestDetailBox extends ConsumerWidget {
  final String name;
  final String age;
  final int count;
  // final String id;
  final VoidCallback deleteClick;
  const GuestDetailBox(
      {super.key,
      required this.name,
      required this.age,
      required this.count,
...
class AddMoreGuests extends ConsumerWidget {
  final VoidCallback onTap;
  const AddMoreGuests({super.key, required this.onTap});
