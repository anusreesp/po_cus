...
class ExpansionSelectionList extends StatelessWidget {
  final String title;
  final String subtitle;
  final List<DemoDrinksModel> selectedDrinks;
  final void Function(DemoDrinksModel data) select;
  final void Function(DemoDrinksModel data) deSelect;
  ExpansionSelectionList(
      {Key? key,
    ...
    return ExpansionTile(
      title: Text(
        ...
        style: const TextStyle(
            fontSize: 12,
            color: /* Colors.black87 */ HtpTheme.whiteColor,
