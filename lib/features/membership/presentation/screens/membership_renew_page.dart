...
class MembershipRenewPage extends ConsumerWidget {
        ...
        Navigator.pushAndRemoveUntil(
            ...
            MaterialPageRoute(
                builder: (context) => const ConfirmationDisplayPage(
                      ...
                      title: 'Renew request sent !',
                      description:
                          'Your request for membership renew has been sent to the Party One team',
                    )),
            (route) => route.isFirst);
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                SvgPicture.asset('assets/svg/icons/membership/membership.svg'),
                const Padding(
                ...
                const Padding(
                    ...
                    child: Text(
                      'To proceed with the membership we would require you to request for renewal',
