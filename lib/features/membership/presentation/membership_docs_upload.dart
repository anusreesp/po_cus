...
//
// class MembershipDocsUpload extends StatefulWidget {
//   final MembershipData data;
//   const MembershipDocsUpload({super.key, required this.data});
//
//   @override
//   State<MembershipDocsUpload> createState() => _MembershipDocsUploadState();
// }
//
// class _MembershipDocsUploadState extends State<MembershipDocsUpload> {
//   File? frontId;
//   File? backId;
//
//   @override
...
//                   ),
//                   Text(
//                     widget.data.id == '91e5aae1-6edd-4394-a648-5908084db3e7'
//                         ? "Hello Cabin Crews!"
...
//                     final controller = ref.watch(membershipApplicationProvider);
...
//                                       frontIdPath: frontId?.path,
//                                       backIdPath: backId?.path);
//                             }
//                           },
//                           text: "CONTINUE",
//                           height: 40,
